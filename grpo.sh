...
TEST_DATASET=${TEST_FILE:-["$TEST_DATA_DIR/AIME25/test.parquet", "$TEST_DATA_DIR/AIME24/test.parquet"]}
...
export EXP_SHORT_NAME="Qwen3-8B-Base-GRPO" # TODO:

export PROJECT_PATH=checkpoint_rerun0711
